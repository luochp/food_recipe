...
data = {
    'train':
    datasets.ImageFolder(root="data_for_nn/train/", transform=image_transforms['train']),
    'valid':
    datasets.ImageFolder(root="data_for_nn/valid/", transform=image_transforms['valid']),
    'test':
    datasets.ImageFolder(root="data_for_nn/test/", transform=image_transforms['valid']),
}
